        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              {
                step: '1',
                title: 'Fill in an English form',
                body: 'Enter your client name, amount, and service description. We handle the Portuguese fields automatically.',
              },
              {
                step: '2',
                title: 'We generate the recibo',
                body: 'VerdeDesk creates a fully compliant recibo verde — correct document type, VAT status, and activity code.',
              },
              {
                step: '3',
                title: 'Track and stay compliant',
                body: 'Your income dashboard updates. You get alerts before VAT thresholds and social security deadlines.',
              },
            ].map(({ step, title, body }) => (
              <div key={step} className="text-center">
                ...
                <p className="text-verde-100 text-sm">{body}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="mt-12 mb-8 space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-2xl">✅</span>
                <div>
                  <span className="font-semibold text-verde-800 block">NHR 2.0 Eligibility Checker</span>
                  <span className="text-verde-600 text-sm">Find out if you qualify for the 20% flat tax rate under Portugal's IFICI regime</span>
                </div>
              </div>
            </Link>
          </div>
